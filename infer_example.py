...
if __name__ == '__main__':
    ...
    opt.state_dict_path = '/content/drive/MyDrive/ABSA/state_dict/lcf_bert_restaurant_val_acc_0.991'
    opt.embed_dim = 300
    opt.hidden_dim = 300
    opt.max_seq_len = 85
    opt.bert_dim = 768
    ...
    fname='/content/drive/MyDrive/ABSA/output2021.txt'
    fin = open(fname, 'r', encoding='utf-8', newline='\n', errors='ignore')
    lines = fin.readlines()
    fin.close()
    all_data = []
    
    f = open("/content/drive/MyDrive/ABSA/value2021out.txt", "a")
